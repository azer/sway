...
//
// In your "lib/bafa_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/bafa_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/bafa_web/channels/user_socket.ex":
//
