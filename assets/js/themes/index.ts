...
export const { styled, css, theme } = createStitches({
  theme: {
    colors: {
      ...
      shellBlur1: 'rgba(15, 100, 222, 0.23)',
      headerFg: 'rgba(255, 255, 255, 0.9)',
      navigationFocusFg: '$white',
      navigationFocusBg: 'rgba(255, 255, 255, 0.05)',
      navigationFg: 'rgba(255, 255, 255, 0.6)',
      navigationBlur2: 'rgba(126, 33, 50, 0.175)',
      navigationBlur1: 'rgba(15, 100, 222, 0.08)',
      ...
      statusTrayButtonBg: 'rgba(255, 255, 255, 0.025)',
      statusTrayButtonHoverBg: 'rgba(255, 255, 255, 0.05)',
      statusTrayButtonHoverFg: 'rgba(255, 255, 255, 0.5)',
      ...
      presenceModelineFocusBlur: 'rgba(242, 201, 76, 0.1)',
      presenceModelineAwayFg: 'rgba(255, 93, 224, 0.9)',
      presenceModelineAwayBlur: 'rgba(255, 93, 224, 0.1)',
      ...
      commandPaletteSelectedCommandBg: 'rgba(255, 255, 255, 0.08)',
